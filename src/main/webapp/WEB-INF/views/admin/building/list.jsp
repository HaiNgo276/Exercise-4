                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-6">
                                                    <label class="name">Diên tích sàn</label>
...
<%--                                                    <input type="text" class="form-control" name="street" value="">--%>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-4">
                                                    <label class="name">Sổ tầng hầm</label>
...
<%--                                                    <input type="text" class="form-control" name="managerPhoneNumber" value="">--%>
                        ...
                        <div class="pull-right">
                            ...
                            <button class="btn btn-white btn-danger btn-bold" title="Xóa tòa nhà" id="btnDeleteBuilding">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-striped table-bordered table-hover" id="staffList">
                    <thead>
                    <tr>
                        <td class="center">Chọn nhân viên</td>
                        <td class="center">Tên nhân viên</td>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
