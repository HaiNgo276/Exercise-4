            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="formData">
                        ...
                        <input type="text" class="form-control mt-3" id= "phone" placeholder="Số điện thoại">
                        <input type="text" class="form-control mt-3" id="demand" placeholder="Nội dung">
            ...
            if(formData){
                ...
                $.each(formData, function(key, value){
                    ...
                    if (value === "") {
                        if(key === "fullname"){
                            var inputField = $('#name');
                            var errorSpan = $('<span>Vui lòng điền họ và tên</span>');
                            inputField.after(errorSpan);
                        }
                        else if(key === "phone"){
                            var inputField = $('#phone');
                            var errorSpan = $('<span >Vui lòng điền số điện thoại</span>');
                            inputField.after(errorSpan);
                        }
                    }
                    else{
